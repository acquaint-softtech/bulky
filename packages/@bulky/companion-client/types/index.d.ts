...
export class RequestClient {
  constructor(bulky: bulky, opts: RequestClientOptions);
...
/**
 * Options for Providers that can be passed in by bulky users through
 * Plugin constructors.
 */
...
export class Provider extends RequestClient {
  constructor(bulky: bulky, opts: ProviderOptions);
