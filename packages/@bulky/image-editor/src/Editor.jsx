...
export default class Editor extends Component {
  ...
  renderGranularRotate() {
    ...
    return (
      ...
      <label
        ...
        className="bulky-ImageCropper-rangeWrapper bulky-u-reset"
      >
        <input
          className="bulky-ImageCropper-range bulky-u-reset"
          type="range"
  ...
  renderRevert() {
    ...
    return (
      <button
        type="button"
        className="bulky-u-reset bulky-c-btn"
  ...
  render() {
    ...
    return (
      <div className="bulky-ImageCropper">
        <div className="bulky-ImageCropper-container">
          <img
            className="bulky-ImageCropper-image"
        ...
        <div className="bulky-ImageCropper-controls">
