...
export default function StatusBar(props) {
  ...
  const progressClassNames = classNames("bulky-StatusBar-progress", {
  ...
  return (
    <div className={statusBarClassNames} aria-hidden={isHidden}>
      ...
      <div className="bulky-StatusBar-actions">
        ...
        {showRetryBtn ? <RetryBtn i18n={i18n} bulky={bulky} /> : null}
        ...
        {showCancelBtn ? <CancelBtn i18n={i18n} bulky={bulky} /> : null}
