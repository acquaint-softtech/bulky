...
export default function RecordingScreen(props) {
  ...
  return (
    <div className="bulky-Audio-container">
      <div className="bulky-Audio-audioContainer">
        {hasRecordedAudio ? (
          <audio className="bulky-Audio-player" controls src={recordedAudio} />
        ) : (
          <canvas ref={canvasEl} className="bulky-Audio-canvas" />
        )}
      </div>
      <div className="bulky-Audio-footer">
        <div className="bulky-Audio-audioSourceContainer">
          {shouldShowAudioSourceDropdown ? AudioSourceSelect(props) : null}
        </div>
        <div className="bulky-Audio-buttonContainer">
        ...
        <div className="bulky-Audio-recordingLength">
          {!hasRecordedAudio && (
            <RecordingLength
