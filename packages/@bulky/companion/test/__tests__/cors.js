...
describe("cors", () => {
  test("should properly merge with existing headers", () => {
    ...
    expect(res.setHeader.mock.calls).toEqual([
      ...
      [
        ...
        "test-allow-header,bulky-auth-token,bulky-versions,bulky-credentials-params,authorization,origin,content-type,accept",
      ],
      [
        "Access-Control-Expose-Headers",
        "test,access-control-allow-headers,i-am",
      ],
      ["Content-Length", "0"],
    ]);
  ...
  test("should also work when nothing added", () => {
    ...
    expect(res.setHeader.mock.calls).toEqual([
      ...
      [
        "Access-Control-Allow-Headers",
        "bulky-auth-token,bulky-versions,bulky-credentials-params,authorization,origin,content-type,accept",
      ],
