...
exports.buildHelpfulStartupMessage = (companionOptions) => {
  ...
  return stripIndent`
    ...
    - Be sure to add ${callbackURLs.join(
      ", "
    )} as your Oauth redirect uris on their corresponding developer interfaces.
    - The URL ${buildURL(
      "/metrics",
      true
    )} is available for  statistics to keep Companion running smoothly
    - https://github.com/transloadit/bulky/issues - report your bugs here
