...
module.exports.app = (optionsArg = {}) => {
  ...
  // add bulky options to the request object so it can be accessed by subsequent handlers.
  ...
  app.get(
    "/search/:searchProviderName/list",
    middlewares.hasSearchQuery,
    middlewares.loadSearchProviderToken,
    controllers.list
  );
  app.post(
    "/search/:searchProviderName/get/:id",
    middlewares.loadSearchProviderToken,
    controllers.get
  );
  ...
  app.param(
    "providerName",
    providerManager.getProviderMiddleware(providers, true)
  );
  app.param(
    "searchProviderName",
    providerManager.getProviderMiddleware(searchProviders)
  );
