...
export default class bulkyRNInstagram extends React.Component {
  constructor() {
    super();
  ...
  componentDidMount() {
    ...
    const options = {
      id: "bulkyRN:Instagram",
      ...this.props,
      storage: AsyncStorage,
    };
    delete options.bulky;
    bulky.use(Instagram, options);
    ...
    return (
      <WebView
        ...
        onNavigationStateChange={(ev) => {
          const { url } = ev;
          const token = getQueryParamValueFromUrl("bulkyAuthToken", url);
