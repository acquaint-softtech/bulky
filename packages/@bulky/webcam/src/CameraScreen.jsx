...
class CameraScreen extends Component {
  ...
  render() {
    ...
    return (
      <div className="bulky bulky-Webcam-container">
        <div className="bulky-Webcam-videoContainer">
          <video
            /* eslint-disable-next-line no-return-assign */
            ref={(videoElement) => (this.videoElement = videoElement)}
            className={`bulky-Webcam-video  ${
              mirror ? "bulky-Webcam-video--mirrored" : ""
            }`}
            /* eslint-disable-next-line react/jsx-props-no-spreading */
            {...videoProps}
          />
        </div>
        <div className="bulky-Webcam-footer">
          <div className="bulky-Webcam-videoSourceContainer">
            {shouldShowVideoSourceDropdown
              ? VideoSourceSelect(this.props)
              : null}
          </div>
          <div className="bulky-Webcam-buttonContainer">
          ...
          <div className="bulky-Webcam-recordingLength">
