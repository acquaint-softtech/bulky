...
import type { StatusBarLocale } from "@bulky/status-bar";
import type { ThumbnailOptions } from "@bulky/thumbnail-generator";
...
export interface DashboardOptions extends Options {
  ...
  metaFields?: MetaField[] | ((file: bulkyFile) => MetaField[]);
  note?: string | null;
  plugins?: string[];
  fileManagerSelectionType?: "files" | "folders" | "both";
  proudlyDisplayPoweredBybulky?: boolean;
