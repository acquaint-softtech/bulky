...
class AddFiles extends Component {
  ...
  renderHiddenInput = (isFolder, refCallback) => {
    return (
      <input
        className="bulky-Dashboard-input"
        hidden
        aria-hidden="true"
        tabIndex={-1}
  ...
  renderMyDeviceAcquirer = () => {
    return (
      <div
        className="bulky-DashboardTab"
        role="presentation"
        data-bulky-acquirer-id="MyDevice"
      >
        <button
          type="button"
          className="bulky-u-reset bulky-c-btn bulky-DashboardTab-btn"
          role="tab"
          tabIndex={0}
        ...
        >
          ...
          >
            <g fill="none" fillRule="evenodd">
              <rect
                className="bulky-ProviderIconBg"
                width="32"
                height="32"
                rx="16"
                fill="#2275D7"
          ...
          <div className="bulky-DashboardTab-name">
  ...
  renderPhotoCamera = () => {
    return (
      <div
        className="bulky-DashboardTab"
        role="presentation"
        data-bulky-acquirer-id="MobilePhotoCamera"
      >
        <button
          type="button"
          className="bulky-u-reset bulky-c-btn bulky-DashboardTab-btn"
  ...
  renderVideoCamera = () => {
    return (
      <div
        className="bulky-DashboardTab"
        role="presentation"
        data-bulky-acquirer-id="MobileVideoCamera"
      >
        <button
          type="button"
          className="bulky-u-reset bulky-c-btn bulky-DashboardTab-btn"
  ...
  renderBrowseButton = (text, onClickFn) => {
    ...
    return (
      <button
        type="button"
        className="bulky-u-reset bulky-c-btn bulky-Dashboard-browse"
        onClick={onClickFn}
        data-bulky-super-focusable={numberOfAcquirers === 0}
      >
        {text}
      </button>
    );
  ...
  renderDropPasteBrowseTagline = () => {
    ...
    return (
      <div class="bulky-Dashboard-AddFiles-title">
        {
  ...
  [Symbol.for("bulky test: disable unused locale key warning")]() {
  ...
  renderAcquirer = (acquirer) => {
    return (
      <div
        className="bulky-DashboardTab"
        role="presentation"
        data-bulky-acquirer-id={acquirer.id}
      >
        <button
          type="button"
          className="bulky-u-reset bulky-c-btn bulky-DashboardTab-btn"
          ...
          tabIndex={0}
          data-cy={acquirer.id}
          aria-controls={`bulky-DashboardContent-panel--${acquirer.id}`}
          aria-selected={this.props.activePickerPanel.id === acquirer.id}
          data-bulky-super-focusable
          onClick={() => this.props.showPanel(acquirer.id)}
        >
          {acquirer.icon()}
          <div className="bulky-DashboardTab-name">{acquirer.name}</div>
        </button>
      </div>
    );
  };
  ...
  renderSourcesList = (acquirers, disableLocalFiles) => {
    ...
    return (
      <div className="bulky-Dashboard-AddFiles-list" role="tablist">
  ...
  renderPoweredBybulky() {
    ...
    const bulkyBranding = (
      <span>
        <svg
          aria-hidden="true"
          focusable="false"
          className="bulky-c-icon bulky-Dashboard-poweredByIcon"
          width="11"
          height="11"
          viewBox="0 0 11 11"
        >
        ...
        <span className="bulky-Dashboard-poweredBybulky">bulky</span>
      </span>
    );

    const linkText = i18nArray("poweredBy", { bulky: bulkyBranding });
    ...
    return (
      <a
        ...
        target="_blank"
        className="bulky-Dashboard-poweredBy"
      >
        {linkText}
      </a>
    );
  ...
  render() {
    ...
    return (
      <div className="bulky-Dashboard-AddFiles">
        ...
        <div className="bulky-Dashboard-AddFiles-info">
          {this.props.note && (
            <div className="bulky-Dashboard-note">{this.props.note}</div>
          )}
          {this.props.proudlyDisplayPoweredBybulky &&
            this.renderPoweredBybulky(this.props)}
        </div>
      </div>
    );
  }
