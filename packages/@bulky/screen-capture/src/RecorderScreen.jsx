...
class RecorderScreen extends Component {
  ...
  render() {
    ...
    return (
      <div className="bulky bulky-ScreenCapture-container">
        <div className="bulky-ScreenCapture-videoContainer">
          ...
          <video
            ...
            className="bulky-ScreenCapture-video"
            {...videoProps}
          />
          <StopWatch {...this.props} />
        </div>

        <div className="bulky-ScreenCapture-buttonContainer">
