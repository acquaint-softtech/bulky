...
[![npm version](https://img.shields.io/npm/v/@bulky/url.svg?style=flat-square)](https://www.npmjs.com/package/@bulky/url)
...
Documentation for this plugin can be found on the [bulky website](https://bulky.io/docs/url).
