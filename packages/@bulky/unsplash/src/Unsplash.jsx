...
import { SearchProvider, Provider } from "@bulky/companion-client";
import { SearchProviderViews } from "@bulky/provider-views";
...
export default class Unsplash extends UIPlugin {
  ...
  constructor(bulky, opts) {
    ...
    this.icon = () => (
      <svg viewBox="0 0 32 32" height="32" width="32" aria-hidden="true">
        <path
          ...
          fill="#fff"
        />
        <rect className="bulky-ProviderIconBg" width="32" height="32" rx="16" />
    ...
    this.provider = new SearchProvider(bulky, {
