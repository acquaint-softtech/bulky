...
uz_UZ.strings = {
  ...
  dashboardTitle: "bulky boshqaruv paneli",
  dashboardWindowTitle:
    "bulky asboblar paneli oynasi (yopish uchun escape tugmasini bosing)",
  ...
  pluginNameZoom: "Zoom",
  poweredBy: "%{bulky} tomonidan quvvatlanadi",
  processingXFiles: {
...
if (typeof bulky !== "undefined") {
  globalThis.bulky.locales.uz_UZ = uz_UZ;
}
