...
fr_FR.strings = {
  ...
  allowAccessDescription:
    "Pour prendre des photos ou enregistrer une vidéo avec votre caméra, veuillez autoriser l'accès à votre caméra pour ce site.",
  ...
  dashboardWindowTitle:
    "Fenêtre de téléchargeur de fichier (Appuyez sur echap pour fermer)",
  ...
  noDuplicates:
    'Impossible d\'ajouter le fichier "%{fileName}", il existe déjà',
...
if (typeof bulky !== "undefined") {
  globalThis.bulky.locales.fr_FR = fr_FR;
}
