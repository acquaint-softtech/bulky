...
fa_IR.strings = {
  ...
  allowAccessDescription:
    "برای استفاده از دوربین جهت عکس و فیلمبرداری، لطفا به این سایت اجازه‌ی دسترسی به دوربین را بدهید",
  ...
  recoveredAllFiles:
    "تمام فایل ها بازیابی شد. اکنون می‌توانید بارگذاری را ازسربگیرید دهید.",
  recoveredXFiles: {
...
if (typeof bulky !== "undefined") {
  globalThis.bulky.locales.fa_IR = fa_IR;
}
