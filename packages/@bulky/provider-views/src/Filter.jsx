...
export default class Filter extends Component {
  ...
  render() {
    ...
    return (
      <div className="bulky-ProviderBrowser-filter">
        <input
          className="bulky-u-reset bulky-ProviderBrowser-filterInput"
          type="text"
        ...
        <svg
          aria-hidden="true"
          focusable="false"
          className="bulky-c-icon bulky-ProviderBrowser-filterIcon"
          width="12"
          height="12"
          viewBox="0 0 12 12"
        >
        ...
        {filterInput && (
          <button
            className="bulky-u-reset bulky-ProviderBrowser-filterClose"
            type="button"
