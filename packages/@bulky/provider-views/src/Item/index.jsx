...
export default (props) => {
  ...
  const className = classNames(
    "bulky-ProviderBrowserItem",
    { "bulky-ProviderBrowserItem--selected": isChecked },
    { "bulky-ProviderBrowserItem--disabled": isDisabled },
    { "bulky-ProviderBrowserItem--noPreview": itemIconString === "video" }
  );
      ...
      return (
        ...
        <GridListItem {...props} className={className} itemIconEl={itemIconEl}>
          <a
            ...
            className="bulky-ProviderBrowserItem-author"
          >
            {author.name}
          </a>
        </GridListItem>
