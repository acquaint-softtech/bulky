...
import {
  ...
  metaFields,
  plugins,
  bulky as bulkyPropType,
} from "./propTypes.js";
import getHTMLProps from "./getHTMLProps.js";
import nonHtmlPropsHaveChanged from "./nonHtmlPropsHaveChanged.js";

/**
 * React Component that renders a Dashboard for an bulky instance in a Modal
...
class DashboardModal extends Component {
  ...
  componentDidUpdate(prevProps) {
    const { bulky, open, onRequestClose } = this.props;
...
DashboardModal.propTypes = {
  ...
  metaFields,
  proudlyDisplayPoweredBybulky: PropTypes.bool,
...
// Must be kept in sync with @bulky/dashboard/src/Dashboard.jsx.
