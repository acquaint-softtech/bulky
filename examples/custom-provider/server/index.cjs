...
// instead of the npm version—in a real app use `require('@bulky/companion')`
const bodyParser = require("body-parser");
const session = require("express-session");
const bulky = require("@bulky/companion");
...
app.get("/", (req, res) => {
  ...
  res.send("Welcome to my bulky companion service");
});
...
app.use(bulky.app(bulkyOptions).app);
...
bulky.socket(app.listen(3020), bulkyOptions);
