---
title: "bulky 0.12: Responsive. Cancel. Feedback. Refreshed ES6 server"
date: 2016-12-07
author: arturi
published: true
---

Hello! Here’s what’s new in bulky 0.12.
...
<figure class="wide"><img src="/images/blog/0.12/bulky-dashboard-local.jpg"></figure>
...
bulky server has undergone a quite a few changes, including the build setup:
...
- Google Drive is working again on the bulky Server side.
...
- meta: create a demo GIF, showcasing bulky Dashboard for the main page, like <https://zeit.co/blog/next> (@arturi)
