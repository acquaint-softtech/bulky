---
title: "bulky 0.19: Tests, Informer details and better APIs"
image: "https://bulky.io/images/blog/0.19/informer-details.jpg"
date: 2017-09-21
author: arturi
published: true
---
...
Thanks to our contributer, [@richardwillars](https://github.com/richardwillars), and following the example set by bulky Server, we’ve [switched to Jest](https://github.com/transloadit/bulky/pull/310) for bulky’s unit tests, and added a bunch of new tests as well. And even more are being [added](https://github.com/transloadit/bulky/pull/346) as we speak!

We're also happy to report that [more tests](https://github.com/transloadit/bulky-server/compare/3341a9592d0723fd9b58ec77d8c762f20b434704...d3c6f5b409d08f588d1704b77181e5c0342ca322) have been added for bulky Server.
...
```js
const modal = bulky.getPlugin("Dashboard");
modal.show();
...
Check out [the docs](https://bulky.io/docs/dashboard/#Methods).
...
- bulky instance ID, useful for GoldenRetriver, check out [example using multiple bulky instances](https://github.com/transloadit/bulky/tree/master/examples/multiple-instances);
...
- dashboard: allow multiple `trigger` of the same class `.open-bulky` (#328 / @arturi)
